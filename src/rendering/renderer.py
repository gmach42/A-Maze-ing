...
def draw_rectangle(img_data: ImgData, x: int, y: int,
...
def draw_maze_walls(img_data: ImgData, maze: list[list[int]],
                    cell_size: int, wall_width: int, color: int) -> None:
