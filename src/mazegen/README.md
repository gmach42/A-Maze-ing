...
algorithm: int | None = 1
```
### All-in-one method:
```py
# Create a complete maze and print it to an output file
maze_manager.create_complete_maze(height, width, perfect, start, end, output_file, seed, algorithm)
```

### Using each component separately:
```py
# Create a maze
maze: list[list[int]] = maze_manager.create_maze(height, width, perfect, seed, algorithm)
...
![Example of a maze generated by the module](https://private-user-images.githubusercontent.com/242624862/550350568-67eef766-2b61-4fd4-8c38-cff22b0ad70e.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3NzEyMzM3NDEsIm5iZiI6MTc3MTIzMzQ0MSwicGF0aCI6Ii8yNDI2MjQ4NjIvNTUwMzUwNTY4LTY3ZWVmNzY2LTJiNjEtNGZkNC04YzM4LWNmZjIyYjBhZDcwZS5wbmc_.kESrFkQI2_s40C1VSfpo9HTAMMnZTOwb_Ek0VuO58a4)
