...
def manage_mouse(button, x, y, xvar, win):
...
def manage_mouse_1(button, x, y, xvar):
    manage_mouse(button, x, y, xvar, xvar.win_1)

def manage_mouse_2(button, x, y, xvar):
    manage_mouse(button, x, y, xvar, xvar.win_2)

def manage_close_1(xvar):
    xvar.mlx.mlx_loop_exit(xvar.mlx_ptr)

def manage_close_2(xvar):
...
def main():
    ...
    xvar.mlx.mlx_hook(xvar.win_2, 2, 1, manage_key_press, xvar)  # KeyPress event
    xvar.mlx.mlx_expose_hook(xvar.win_1, manage_expose, xvar)
    xvar.mlx.mlx_mouse_hook(xvar.win_1, manage_mouse_1, xvar)
    xvar.mlx.mlx_mouse_hook(xvar.win_2, manage_mouse_2, xvar)
    xvar.mlx.mlx_hook(xvar.win_1, 33, 0, manage_close_1, xvar)  # WM_DELETE_WINDOW
    xvar.mlx.mlx_hook(xvar.win_2, 33, 0, manage_close_2, xvar)  # WM_DELETE_WINDOW
